package com.android.babo.signalsfrommars.model;

import com.android.babo.signalsfrommars.R;

/**
 * Created by babo on 03/08/15.
 */
public class Story {
    ...
    public Story(){
        ...
        mPages[3] = new Page(
                R.mipmap.page3,
                "Your EVA suit is equipped with a headlamp, which you use to navigate the cave. After searching " +
                        "for a while your oxygen levels are starting to get pretty low. You know you should go refill " +
                        "your tank, but there's a very faint light up ahead.",
        ...
        mPages[4] = new Page(
                R.mipmap.page4,
                "The rover is covered in dust and most of the solar panels are broken. But you are quite " +
                        "surprised to see the on-board system booted up and running. In fact, there is a message " +
                        "on the screen: \"%1$s, come to 28.543436, -81.369031.\" Those coordinates aren't far, " +
                        "but you don't know if your oxygen will last there and back.",
        ...
        mPages[5] = new Page(
                R.mipmap.page5,
                "After a long walk slightly uphill, you end up at the top of a small crater. You look around, " +
                        "and are overjoyed to see your favorite android, %1$s-S1124. It had been lost on a " +
                        "previous mission to Mars! You take it back to your ship and fly back to Earth."
        );

        mPages[6] = new Page(
                R.mipmap.page6,
                "You arrive home on Earth. While your mission was a success, you forever wonder what was " +
                        "sending that signal. Perhaps a future mission will be able to investigate..."
        );
